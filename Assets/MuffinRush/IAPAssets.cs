...
namespace Soomla.Example {
	...
	public class IAPAssets : IStoreAssets{
		...
		public const string BALLOON7_PACK_PRODUCT_ID      = "com.fresvii.chicken_balloon.items.balloons.7a";
		public const string BALLOON40_PACK_PRODUCT_ID      = "com.fresvii.chicken_balloon.items.balloons.40a";
		public const string BALLOON100_PACK_PRODUCT_ID      = "com.fresvii.chicken_balloon.items.balloons.100a";
		...
		*/
	    ...
	    public static VirtualCurrencyPack BALLOON7_PACK = new VirtualCurrencyPack(
			"7 Balloons",							// name
			"x7 Balloons - Bronze Balloon Package",		 // description
			"balloons_7",							// item id
		...
		public static VirtualCurrencyPack BALLOON40_PACK = new VirtualCurrencyPack(
			"40 Balloons",							// name
			"x40 Balloons - Silver Balloon Packages",		 // description
			"balloons_40",							// item id
		...
		public static VirtualCurrencyPack BALLOON100_PACK = new VirtualCurrencyPack(
			"100 Balloons",							// name
			"x100 Balloons - Gold Balloon Package",		 // description
