...
namespace Soomla.Example {
	...
	public class ExampleEventHandler {
		...
		public void onBillingNotSupported() {
			SoomlaUtils.LogDebug("", "onBillingNotSupported");
		...
		public void onMarketPurchaseCancelled(PurchasableVirtualItem pvi) {
			SoomlaUtils.LogDebug("", "onMarketPurchaseCancelled");
			if (Application.loadedLevelName == "GameScene") {
				//キャンセルされたらゲームオーバー処理.
				GameController.TouchContinueNo();
			}
		...
		public void onUnexpectedErrorInStore(string message) {
			SoomlaUtils.LogDebug("", "onUnexpectedErrorInStore");
			if (Application.loadedLevelName == "GameScene") {
				//エラーがあったらゲームオーバー処理.
				GameController.TouchContinueNo();
			}
		...
		public void onSoomlaStoreInitialized() {
			SoomlaUtils.LogDebug("", "onSoomlaStoreInitialized");
